class AppConstants {
  ...
  static const String baseUrl = 'https://dev.tgc-carpets.uz/api/v1';
  static const String storageUrl = 'https://dev.tgc-carpets.uz/storage/';

  /// Base URL for public (non-versioned) API endpoints such as app-update checks.
  static const String publicApiUrl = 'https://dev.tgc-carpets.uz/api';
