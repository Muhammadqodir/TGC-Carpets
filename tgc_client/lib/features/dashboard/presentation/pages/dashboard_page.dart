                      ...
                      builder: (context, authState) {
                        ...
                        if (RolePermissions.canAccessStock(user)) {
                          visibleCards.add(_DashboardCard(
                            ...
                            onTap: () =>
                                context.pushNamed(AppRoutes.productsStockName),
                          ));
                        }
                        ...
                        if (RolePermissions.canAccessProductAttributes(user)) {
                          visibleCards.add(_DashboardCard(
                        ...
                        if (RolePermissions.canAccessRawMaterials(user)) {
                          visibleCards.add(_DashboardCard(
                            ...
                            onTap: () =>
                                context.pushNamed(AppRoutes.rawMaterialsName),
                          ));
                        }
