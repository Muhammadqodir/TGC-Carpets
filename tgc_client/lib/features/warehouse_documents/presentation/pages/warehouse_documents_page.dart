...
class WarehouseDocumentsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) => sl<WarehouseDocsBloc>()
            ..add(const WarehouseDocsLoadRequested()),
        ),
        BlocProvider(
          create: (_) =>
              sl<EmployeesBloc>()..add(const EmployeesLoadRequested()),
        ),
      ],
      child: const _WarehouseDocumentsContent(),
    );
  }
}

class _WarehouseDocumentsContent extends StatefulWidget {
  const _WarehouseDocumentsContent();

  @override
  State<_WarehouseDocumentsContent> createState() =>
      _WarehouseDocumentsContentState();
}

class _WarehouseDocumentsContentState
    extends State<_WarehouseDocumentsContent> {
          ...
          BlocBuilder<WarehouseDocsBloc, WarehouseDocsState>(
            builder: (context, state) {
              ...
              return DesktopStatusBar(
                child: Text(
                  loaded != null ? '$loaded ta hujjat ko\'rsatilmoqda' : '',
