...
class ProductAttributesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _ProductAttributesView(),
    );
  }
}

class _ProductAttributesView extends StatefulWidget {
  const _ProductAttributesView();

  @override
  State<_ProductAttributesView> createState() => _ProductAttributesViewState();
}

class _ProductAttributesViewState extends State<_ProductAttributesView>
                      ...
                      children: [
                        ...
                        AttributeListPanel<dynamic>(
                          ...
                          onAdd: () => SimpleAttributeFormDialog.show(
                            ...
                            onSubmit: (ctx, value) {
                              context.read<ProductAttributesBloc>().add(ColorCreateRequested(value));
                            },
                          ),
