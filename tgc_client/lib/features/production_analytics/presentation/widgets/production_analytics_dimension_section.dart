...
class ProductionAnalyticsDimensionSection extends StatefulWidget {
  final String title;
  final List<ProductionDimensionItem> items;
  final Color accentColor;

  const ProductionAnalyticsDimensionSection({
    super.key,
    required this.title,
    required this.items,
  ...
  @override
  State<ProductionAnalyticsDimensionSection> createState() =>
      _ProductionAnalyticsDimensionSectionState();
}

class _ProductionAnalyticsDimensionSectionState
    extends State<ProductionAnalyticsDimensionSection> {
