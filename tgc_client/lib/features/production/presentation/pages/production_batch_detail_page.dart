...
class _InfoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final clientItem =
        batch.items.where((i) => i.sourceClientShopName != null).firstOrNull;
    final clientName = clientItem?.sourceClientShopName;
    final clientRegion = clientItem?.sourceClientRegion;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            InfoSection(items: [
              InfoSectionItemData(label: 'ID', value: '#${batch.id}'),
              InfoSectionItemData(label: 'Tur', value: batch.typeLabel),
              if (clientName != null)
                InfoSectionItemData(
                  label: 'Mijoz',
                  value: clientRegion != null
                      ? '$clientName / $clientRegion'
                      : clientName,
                ),
              if (batch.machine != null)
                InfoSectionItemData(
                    label: 'Stanok', value: batch.machine!.name),
              if (batch.creator != null)
                InfoSectionItemData(
                    label: 'Yaratdi', value: batch.creator!.name),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          SizedBox(
                              width: 36, child: Text('#', style: labelStyle)),
                          Expanded(
                              flex: 2,
                          ...
                          Expanded(
                              flex: 2, child: Text('Mijoz', style: labelStyle)),
                          SizedBox(
                              width: 72,
                              child: Text('Reja',
                                  style: labelStyle,
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                if (perUnitSqm > 0)
                  SubBodyText(text: '${perUnitSqm.toStringAsFixed(2)} m²'),
              ],
            ),
          ),
          // Source (Mijoz)
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(flex: 4, child: Text('Jami', style: footerStyle)),
