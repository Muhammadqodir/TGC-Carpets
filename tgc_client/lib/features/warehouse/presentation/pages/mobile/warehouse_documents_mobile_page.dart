...
class WarehouseDocumentsMobilePage extends StatefulWidget {
  const WarehouseDocumentsMobilePage({super.key});

  @override
  State<WarehouseDocumentsMobilePage> createState() =>
      _WarehouseDocumentsMobilePageState();
}

class _WarehouseDocumentsMobilePageState
    extends State<WarehouseDocumentsMobilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<WarehouseDocsBloc, WarehouseDocsState>(
