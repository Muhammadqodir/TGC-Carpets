...
class OrderController extends Controller
{
    ...
    {
        $orders = Order::with(['user', 'client', 'items.variant.productColor.product.productType', 'items.variant.productColor.product.productQuality', 'items.variant.productColor.color', 'items.variant.productSize', 'items.productionBatchItems.productionBatch'])
    ...
    {
        $order->load(['user', 'client', 'items.variant.productColor.product.productType', 'items.variant.productColor.product.productQuality', 'items.variant.productColor.color', 'items.variant.productSize', 'items.productionBatchItems.productionBatch']);
