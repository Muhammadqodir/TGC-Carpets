...
class ProductSizeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $sizes = [
            ...
            'Kovrolin' => [
                ['width' => 80, 'length' => 3000],
                ['width' => 100, 'length' => 3000],
                ['width' => 120, 'length' => 3000],
                ['width' => 150, 'length' => 3000],
                ['width' => 200, 'length' => 3000],
                ['width' => 250, 'length' => 3000],
                ['width' => 300, 'length' => 3000],
                ['width' => 350, 'length' => 3000],
                ['width' => 370, 'length' => 3000],
                ['width' => 400, 'length' => 3000],
            ],
            'Yolak'    => [
